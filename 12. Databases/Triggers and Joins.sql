...
/* Creating tables and inserting data inside the tables.*/
...
CREATE OR REPLACE VIEW OrderProductView AS select od.orderNumber, p.productName,p.productLine,od.quantityOrdered, o.orderDate,o.status from orderDetails od JOIN products p ON od.productCode = p.productCode JOIN orders o ON o.orderNumber = od.orderNumber; 
...
Update OrderProductView SET quantityOrdered=100 where orderNumber='10102' and productName='1936 Mercedes-Benz 500K Special Roadster';
...
set @log ="";
insert  into products values ('S10_19497','1952 Alpine Renault 2900','Classic Cars','1:10','Arijit Sarkar Creations','Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',7305,'98.58','214.30');
select @log;
...
Before Insert On Products
for each row
	set NEW.MSRP=1; /* The NEW variable actually refers to the new MYSQL row that will be inserted inside the table and in that row whatever is the MSRP property that will be set to 1000.*/
$

DELIMITER ;
insert  into products values ('S10_19490','1952 Alpine Renault 2100','Classic Cars','1:10','Arijit Sarkar Creations','Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',7305,'98.58','214.30');
/*
