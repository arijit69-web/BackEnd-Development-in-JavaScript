    ...
    */
    try {
      ...
      if (+dec) {
        ...
        await flight.decrement("totalSeats", { by: seats }); // If Booked - decrement the totalSeats by seats
      } else {
        await flight.increment("totalSeats", { by: seats }); // If Canceled - increment the totalSeats by seats
      }
